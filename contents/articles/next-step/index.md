...
この頃から徐々にフリーランスで、日本からプロジェクトを受けるようにしました。そうすることで、少しはこの考え事を払拭できるかなと思って。どことなく定期テストにも似たフリーランスのお仕事は楽しいです。プロジェクトを一から話し、何が必要で何が必要でないかを考えて、デザインと実装をして締め切りに間に合わせる。
